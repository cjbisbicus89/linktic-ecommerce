-- Script de inicialización para la base de datos de productos
-- Crea la estructura inicial y datos de ejemplo según architecture-simplified.md
...
SELECT 'Products database initialized successfully' AS message;
